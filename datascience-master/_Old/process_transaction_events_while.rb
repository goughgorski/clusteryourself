...
def process_transaction_events(schema, tablename, eventidcol, store = true, *query)
  ...
  begin
            ...
            messages.each do |message|
              ...
              if !query.nil?
                ...
                if message.message_id.nil?
                  ...
                  query_count = api.messages(full_query).count
    ...
    $stderr.puts "[#{Time.now}] Finish processing".green
  end
